...
import com.tesatechnology.techgas.BottomSheetDialog;
import com.tesatechnology.techgas.Opciones;
...
public class Principal extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void requestDriver() {
        ...
        Toast.makeText(this, "Debes hacer un pedido para continuar!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getActiveDrivers() {
        mGeofireProvider.getActiveDrivers(mCurrentLatLng, 10).addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                Marker marker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Conductor disponible"));
                marker.setTag(key);
